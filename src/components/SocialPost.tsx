        ...
        <div className="card-body p-4 flex-col items-start lg:flex-row lg:items-center lg:space-x-3 space-y-1 flex-wrap">
          ...
          <div className="flex-1">
            <p>
              ...
              tempor nec feugiat nisl. Ut tristique et egestas quis ipsum
              suspendisse ultrices. Fringilla urna porttitor rhoncus dolor purus
              non enim praesent.
            </p>
          </div>
          ...
          <div className="basis-full">
            <div className="flex flex-row space-x-3 justify-start">
              ...
              <div className="flex-none w-content">5,222 Likes</div>
              <div className="flex-none w-content">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div className="flex-none w-content">100 Comments</div>
            </div>
          </div>
          ...
          <div className="basis-full">
            <div className="flex flex-row space-x-3 justify-start">
              ...
              <div className="flex-none w-content">4,333 Likes</div>
              <div className="flex-none w-content">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div className="flex-none w-content">50 Comments</div>
            </div>
          </div>
          <div className="divider basis-full"></div>
          <div className="basis-full">
            <div className="flex flex-row space-x-3 justify-start">
              ...
              <div className="flex-none w-content">2,444 Likes</div>
              <div className="flex-none w-content">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div className="flex-none w-content">75 Comments</div>
            </div>
          </div>
        </div>
      </div>
