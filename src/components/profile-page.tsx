        ...
        <div className="flex-1 bg-base-200 min-h-screen pr-8 pt-6 pl-8 sm:pl-24 w-full lg:pl-48 xl:pr-0">
          <div className="flex flex-row gap-x-10 mt-5">
                  ...
                  <div className="px-4 py-5 sm:p-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4 text-center">
                        <h3 className="text-3xl font-medium leading-6 text-gray-900 mb-2">
                          John Doe
                        </h3>
                        <p className="text-xl font-medium text-gray-400 mb-5">
                          Connect User Since 2023
                        </p>
                        <p className="text-m font-meduium text-black mb-10">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Quae, eligendi blanditiis ipsam repellat porro
                          iure enim deleniti a. Ut facere tempora velit dolore
                          excepturi voluptates ea autem provident repudiandae
                          odio?
                        </p>
            ...
            <div className="flex-2 pr-6 w-1/4 hidden xl:block box-border text-center">
              <h3 className="text-center font-medium text-3xl mb-5">
                Dashboard Preview
              </h3>
